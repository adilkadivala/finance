...
function FeatureShowCase() {
  return (
    <div id="dash" className="w-full min-h-screen sm:py-20 py-12 px-4 md:px-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-black">SEO Goal Setting</h2>
          ...
          {/* Visual Reports Card */}
          <motion.div
            className="rounded-2xl bg-grediant space-y-4 md:col-span-2"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
            variants={fadeInScale}
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-black">Visual reports</h2>
            <p className="text-slate-400">
